...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%F{7}%n%f%F{8}@%m%f"
  # Context format when not root: user@host. The whole thing grey.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%F{8}%n@%m%f"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PRECISION=8
  ...
  typeset -g POWERLEVEL9K_VCS_MAX_SYNC_LATENCY_SECONDS=8
